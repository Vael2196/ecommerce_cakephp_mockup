...
class OrdersTable extends Table
{
    ...
    public function validationDefault(Validator $validator): Validator
    {
        ...
        $validator
            ->dateTime('order_createdAt')
            ->allowEmptyDateTime('order_createdAt');

        $validator
            ->scalar('order_delivery_address')
            ->maxLength('order_delivery_address', 255)
            ->allowEmptyString('order_delivery_address');
