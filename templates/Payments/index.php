 ...
 */
?>
<div class="payments index content my-text">
    <h3><?= __('Payments') ?></h3>
            ...
            <tbody>
                <?php foreach ($payments as $payment): ?>
                    <tr>
                        ...
                        <td>
                            <?= $this->Html->link('Order #' . $payment->order->order_id, ['controller' => 'Orders', 'action' => 'view', $payment->order->order_id]) ?>
                        </td>
